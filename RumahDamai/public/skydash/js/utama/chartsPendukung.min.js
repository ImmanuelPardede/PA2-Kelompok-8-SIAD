...
function drawChartPendukung(chartData) {
    ...
    if (screenWidth > 768) {
        ...
        // Hide pie chart and show line chart
        ...
        // Hide pie chart and show line chart for medium screens
        document.getElementById("pie-chart-pendukung").style.display = "none";
        document.getElementById("line-chart-pendukung").style.display = "block";
        ...
        // Hide pie chart and show line chart for small screens
        document.getElementById("pie-chart-pendukung").style.display = "none";
        document.getElementById("line-chart-pendukung").style.display = "block";
    } else {
        var lineChart = new google.visualization.LineChart(
        ...
        // Hide pie chart and show line chart for default case
        document.getElementById("pie-chart-pendukung").style.display = "none";
        document.getElementById("line-chart-pendukung").style.display = "block";
    }
}
