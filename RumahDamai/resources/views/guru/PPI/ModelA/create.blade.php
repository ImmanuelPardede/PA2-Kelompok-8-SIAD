...
<div class="col-md-6">
        ...
        <div class="form-group">
            <label for="gambaran_sensory">Gambaran Sensory:</label>
            <input type="text" class="form-control" id="gambaran_sensory" name="gambaran_sensory[]" >
        </div>

        <div class="form-group">
            <label for="data_medis">Data Medis:</label>
            <input type="text" class="form-control" id="data_medis" name="data_medis[]" >
        </div>
        ...
        <div class="form-group">
            <label for="kondisi_lain">Kondisi Lain:</label>
            <input type="text" class="form-control" id="kondisi_lain" name="kondisi_lain[]" >
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label for="jangka_pendek">Tujuan Jangka Pendek:</label>
            <input type="text" class="form-control" id="jangka_pendek" name="jangka_pendek" value="Jangka Pendek" readonly>
        </div>

        <div class="form-group">
            <label for="gambaran_sensory_pendek">Gambaran Sensory:</label>
            <input type="text" class="form-control" id="gambaran_sensory_pendek" name="gambaran_sensory_pendek[]" >
        </div>

        <div class="form-group">
            <label for="data_medis_pendek">Data Medis:</label>
            <input type="text" class="form-control" id="data_medis_pendek" name="data_medis_pendek[]" >
        </div>

        <div class="form-group">
            <label for="hal_disukai_pendek">Hal yang Disukai:</label>
            <input type="text" class="form-control" id="hal_disukai_pendek" name="hal_disukai_pendek[]" >
        </div>

        <div class="form-group">
            <label for="kondisi_lain_pendek">Kondisi Lain:</label>
            <input type="text" class="form-control" id="kondisi_lain_pendek" name="kondisi_lain_pendek[]" >
        </div>
    </div>
        </div>  --}}
