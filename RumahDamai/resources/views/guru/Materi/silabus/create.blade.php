    ...
    <div class="container">
        ...
        <form action="{{ route('silabus.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tahun_kurikulum_id" name="tahun_kurikulum_id">
                    @foreach ($tahunKurikulum as $tahunKurikulumItem)
                        <option value="{{ $tahunKurikulumItem->id }}">{{ $tahunKurikulumItem->tahun_kurikulum }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="buku_pegangan_dan_referensi" name="buku_pegangan_dan_referensi">
            </div>
