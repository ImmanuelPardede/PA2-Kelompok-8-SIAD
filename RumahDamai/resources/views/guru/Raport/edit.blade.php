    ...
    <form action="{{ route('raport.update', $raport->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control js-example-basic-single" id="anak_id" name="anak_id" required>
                ...
                <option value="{{ $anakItem->id }}" {{ $anakItem->id == $raport->anak_id ? 'selected' : '' }}>{{ $anakItem->nama_lengkap }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="periode_awal" placeholder="Bulan Awal" value="{{ $periode_awal }}" required>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="kemampuan[]" value="{{ $detailraport->kemampuan }}" required>
        </div>
        <div class="form-group">
            <label for="kelas_kemampuan">Kelas Kemampuan:</label>
            <input type="text" class="form-control" name="kelas_kemampuan[]" value="{{ $detailraport->kelas_kemampuan }}" required>
        </div>
        <div class="form-group">
