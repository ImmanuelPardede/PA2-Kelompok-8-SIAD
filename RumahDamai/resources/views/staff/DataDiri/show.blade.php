    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <p class="card-description">Status : <span class="text-success">{{ $user->status }}</span></p>
                <div class="row">
                    <div class="col-md-8">
                ...
                <a href="{{ route('staff.DataDiri.edit', ['user' => $user->id]) }}" class="btn btn-primary">Edit Profil</a>
