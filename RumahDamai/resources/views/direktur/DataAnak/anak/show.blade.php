            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        @else
                            <form action="{{ route('direktur.anak.aktifkan', $anak->id) }}" method="post" style="display:inline;">
                                @csrf
                                @method('PATCH')
                        ...
                        @endif
                        <a href="{{ route('direktur.anak.pdf', ['id' => $anak->id]) }}" class="btn btn-primary">Generate PDF</a>
