...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('direktur.orangTuaWali.update', $orangtuawali->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single" id="pendidikan_ibu_id" name="pendidikan_ibu_id">
                            <option value="" disabled {{ !old('pendidikan_ibu_id') && !$orangtuawali->pendidikan_ibu_id ? 'selected' : '' }}>-- Pilih Pendidikan --</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-single" id="pendidikan_ayah_id" name="pendidikan_ayah_id">
                            <option value="" disabled {{ !old('pendidikan_ayah_id') && !$orangtuawali->pendidikan_ayah_id ? 'selected' : '' }}>-- Pilih Pendidikan --</option>
                            @foreach ($pendidikan as $pendidikanItem)
                                <option value="{{ $pendidikanItem->id }}"
