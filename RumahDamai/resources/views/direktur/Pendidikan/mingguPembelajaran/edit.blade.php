...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('direktur.mingguPembelajaran.update', $mingguPembelajaran->id) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <a href="{{ route('direktur.mingguPembelajaran.index') }}" class="btn btn-primary">Batal</a>
