        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.mingguPembelajaran.create') }}" class="btn btn-success mb-3">Tambah Minggu
                        Pembelajaran</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($mingguPembelajaranList as $mingguPembelajaran)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.mingguPembelajaran.edit', $mingguPembelajaran->id) }}"
                                            class="btn btn-warning">Edit</a>
                                        <form method="POST" id="deleteForm{{ $mingguPembelajaran->id }}" class="d-inline"
                                            action="{{ route('direktur.mingguPembelajaran.destroy', $mingguPembelajaran->id) }}">
                                            @csrf
                                            @method('DELETE')
