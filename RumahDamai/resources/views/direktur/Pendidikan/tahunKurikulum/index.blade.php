        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.tahunKurikulum.create') }}" class="btn btn-success mb-3">Tambah Tahun Kurikulum</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($tahunKurikulumList as $tahunKurikulum)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.tahunKurikulum.edit', $tahunKurikulum->id) }}"
                                            class="btn btn-warning">Edit</a>
                                        <form method="POST" id="deleteForm{{ $tahunKurikulum->id }}" class="d-inline"
                                            action="{{ route('direktur.tahunKurikulum.destroy', $tahunKurikulum->id) }}">
                                            @csrf
                                            @method('DELETE')
