        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.kelas.create') }}" class="btn btn-success mb-3">Tambah Kelas</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($kelasList as $kelas)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.kelas.edit', $kelas->id) }}" class="btn btn-warning">Edit</a>
                                        <form method="POST" id="deleteForm{{ $kelas->id }}" class="d-inline"
                                            action="{{ route('direktur.kelas.destroy', $kelas->id) }}">
                                            @csrf
                                            @method('DELETE')
