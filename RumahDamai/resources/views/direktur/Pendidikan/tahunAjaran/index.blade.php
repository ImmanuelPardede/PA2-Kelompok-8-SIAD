        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.tahunAjaran.create') }}" class="btn btn-success mb-3">Tambah Tahun Ajaran</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($tahunAjaranList as $tahunAjaran)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.tahunAjaran.edit', $tahunAjaran->id) }}"
                                            class="btn btn-warning">Edit</a>
                                        <form method="POST" id="deleteForm{{ $tahunAjaran->id }}" class="d-inline"
                                            action="{{ route('direktur.tahunAjaran.destroy', $tahunAjaran->id) }}">
                                            @csrf
                                            @method('DELETE')
