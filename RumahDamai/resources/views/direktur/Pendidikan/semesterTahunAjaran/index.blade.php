    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                @endif
                <a href="{{ route('direktur.semesterTahunAjaran.create') }}" class="btn btn-success mb-3">Tambah Semester Ajaran</a>
            </div>
                    ...
                    <tbody>
                        @forelse ($semesterTahunAjaranList as $semesterTahunAjaran)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('direktur.semesterTahunAjaran.edit', $semesterTahunAjaran->id) }}" class="btn btn-warning">Edit</a>
                                    <form method="POST" id="deleteForm{{ $semesterTahunAjaran->id }}" class="d-inline"
                                        action="{{ route('direktur.semesterTahunAjaran.destroy', $semesterTahunAjaran->id) }}">
                                        @csrf
                                        @method('DELETE')
