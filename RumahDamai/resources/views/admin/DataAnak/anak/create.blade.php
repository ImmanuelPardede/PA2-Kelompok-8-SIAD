                        ...
                        <select class="form-control js-example-basic-single" id="agama_id" name="agama_id"
                            ...
                            @foreach ($agama as $agamaItem)
                                <option value="{{ $agamaItem->id }}"
                                    {{ old('agama_id') == $agamaItem->id ? 'selected' : '' }}>{{ $agamaItem->agama }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <select class="form-control js-example-basic-single" id="jenis_kelamin_id" name="jenis_kelamin_id"
                            ...
                            @foreach ($jenisKelamin as $jenisKelaminItem)
                                <option value="{{ $jenisKelaminItem->id }}"
                                    {{ old('jenis_kelamin_id') == $jenisKelaminItem->id ? 'selected' : '' }}>
                                    {{ $jenisKelaminItem->jenis_kelamin }}</option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <select class="form-control js-example-basic-single" id="golongan_darah_id" name="golongan_darah_id"
                            ...
                            @foreach ($golonganDarah as $golonganDarahItem)
                                <option value="{{ $golonganDarahItem->id }}"
                                    {{ old('golongan_darah_id') == $golonganDarahItem->id ? 'selected' : '' }}>
                                    {{ $golonganDarahItem->golongan_darah }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group" id="kebutuhan_disabilitas_id">
                        ...
                        <select class="form-control js-example-basic-single" name="kebutuhan_disabilitas_id"
                            ...
                            @foreach ($kebutuhanDisabilitas as $kebutuhanDisabilitasItem)
                                @if ($kebutuhanDisabilitasItem && $kebutuhanDisabilitasItem->jenis_kebutuhan_disabilitas)
                                    <!-- Check if the item and its property are not null -->
                                    <option value="{{ $kebutuhanDisabilitasItem->id }}">
                                        {{ $kebutuhanDisabilitasItem->jenis_kebutuhan_disabilitas }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
