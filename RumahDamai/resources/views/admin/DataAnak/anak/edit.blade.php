                ...
                <div class="row">
                    <div class="col-md-8">
                        <form action="{{ route('admin.anak.update', $anak->id) }}" method="post"
                            ...
                            @if ($anak->tipe_anak == 'disabilitas')
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kebutuhan_disabilitas_id"
                                        name="kebutuhan_disabilitas_id" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipe_anak" name="tipe_anak" required>
                                    ...
                                    <option value="disabilitas" @if ($anak->tipe_anak == 'disabilitas') selected @endif>
                                        Disabilitas
                                    </option>
                        ...
                        {{ old('disukai') }}
                            ...
                            <div class="mb-3">
                                <label for="tidak_disukai" class="form-label">Tidak Disukai<span
                        ...
                        {{ old('kelebihan') }}
                            ...
                            <div class="mb-3">
                                <label for="kekurangan" class="form-label">Kekurangan<span
                                        style="color: red">*</span></label>
