        ...
        <form action="{{ route('anak.update', $anak->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tipe_anak" name="tipe_anak" required>
                    ...
                    <option value="disabilitas" @if($anak->tipe_anak == 'disabilitas') selected @endif>Disabilitas</option>
                    <option value="non_disabilitas" @if($anak->tipe_anak == 'non_disabilitas') selected @endif>Non Disabilitas</option>
                </select>
            </div>
