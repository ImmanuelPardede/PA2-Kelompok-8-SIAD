    ...
    <div class="container">
        ...
        <form action="{{ route('anakNonDisabilitas.update', $jenisAnakNonDisabilitas->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="kategori_anak_non_disabilitas" value="{{ old('kategori_anak_non_disabilitas', $jenisAnakNonDisabilitas->kategori_anak_non_disabilitas) }}">
            </div>

            <div class="form-group">
                <label for="jenis_anak_non_disabilitas">Jenis Anak Non Disabilitas:</label>
                <input type="text" class="form-control" name="jenis_anak_non_disabilitas" value="{{ old('jenis_anak_non_disabilitas', $jenisAnakNonDisabilitas->jenis_anak_non_disabilitas) }}">
            </div>
