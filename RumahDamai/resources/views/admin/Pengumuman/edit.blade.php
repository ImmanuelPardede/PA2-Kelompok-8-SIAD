                ...
                <div class="card-body">
                    <form action="{{ route('pengumuman.update', ['id' => $pengumuman->id]) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="judul" type="text" class="form-control" name="judul" value="{{ $pengumuman->judul }}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kategori" type="text" class="form-control" name="kategori" value="{{ $pengumuman->kategori }}">
                            </div>
                        </div>
