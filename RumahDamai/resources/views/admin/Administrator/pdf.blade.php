    ...
    <header>
        <div class="atasan">
            ...
            <div class="konten" style="text-align: center;">
                ...
                <h4>@if ($user->lokasi_penugasan_id == 1)Desa Lumban Silintong, Kecamatan
                    ...
                    @endif</h4>
                <h4>@if($user->lokasi_penugasan_id == 1)Lumban Silintong 22651  @elseif ($user->lokasi_penugasan_id == 2) Andam Dewi 22651 @endif</h4>
            </div>
        </div>
        <hr class="garis1">
