                    ...
                    <tbody>
                        @forelse ($tahunAjaranList as $tahunAjaran)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('tahunAjaran.edit', $tahunAjaran->id) }}" class="btn btn-warning">Edit</a>
                                    <form action="{{ route('tahunAjaran.destroy', $tahunAjaran->id) }}" method="post" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
