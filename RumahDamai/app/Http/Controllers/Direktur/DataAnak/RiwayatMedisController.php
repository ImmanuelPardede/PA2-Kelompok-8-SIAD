...
class RiwayatMedisController extends Controller
{
    public function index()
    {
        ...
        return view('direktur.DataAnak.riwayatMedis.index', compact('riwayatmedisList'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('direktur.DataAnak.riwayatMedis.show', compact('riwayatmedis'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('direktur.DataAnak.riwayatMedis.edit', compact('riwayatmedis', 'anak'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('direktur.riwayatMedis.index')->with('success', 'Riwayat Medis berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('direktur.riwayatMedis.index')->with('success', 'Riwayat Medis berhasil dihapus.');
    }
}
