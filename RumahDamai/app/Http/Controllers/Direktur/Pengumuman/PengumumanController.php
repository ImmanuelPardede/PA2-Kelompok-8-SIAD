...
namespace App\Http\Controllers\Direktur\Pengumuman;
...
class PengumumanController extends Controller
{
    ...
    {
        // Periksa apakah pengguna memiliki peran direktur atau direktur
        if (Auth::user()->role == 'direktur' || Auth::user()->role == 'direktur') {
            return view('direktur.pengumuman.create');
        } else {
    ...
    public function show($id)
    {
        ...
        return view('direktur.pengumuman.show', compact('pengumuman', 'user', 'lokasi'));
    }

    public function edit($id)
    {
        $pengumuman = Pengumuman::findOrFail($id);
        return view('direktur.pengumuman.edit', compact('pengumuman'));
    }
