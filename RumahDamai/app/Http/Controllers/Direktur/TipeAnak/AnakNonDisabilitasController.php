...
namespace App\Http\Controllers\Direktur\TipeAnak;
...
class AnakNonDisabilitasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('direktur.DataAnak.tipeAnak.anakNonDisabilitas.index', compact('anakNonDisabilitasList'));
    ...
    {
        return view('direktur.DataAnak.tipeAnak.anakNonDisabilitas.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('direktur.anakNonDisabilitas.index')->with('success', 'Jenis Anak Non Disabilitas berhasil ditambahkan.');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('direktur.DataAnak.tipeAnak.anakNonDisabilitas.show', compact('anakNonDisabilitas'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('direktur.DataAnak.tipeAnak.anakNonDisabilitas.edit', compact('jenisAnakNonDisabilitas'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('direktur.anakNonDisabilitas.index')->with('success', 'Jenis Anak Non Disabilitas berhasil diperbarui.');
    }
