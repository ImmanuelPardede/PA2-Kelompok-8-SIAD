...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    */
    ...
    Route::get('/admin/anak/{id}/nonaktifkan', [AnakController::class, 'nonaktifkan'])
        ->name('admin.anak.nonaktifkan');
    Route::post('/admin/anak/{id}/nonaktifkan', [AnakController::class, 'nonaktifkan'])
        ->name('admin.anak.nonaktifkan');
    Route::patch('/admin/anak/{id}/nonaktifkan', [AnakController::class, 'nonaktifkan'])
        ->name('admin.anak.nonaktifkan');
    ...
    */
    ...
    // Kebutuhan Disabilitas Controller
    ...
    */
    ...
    // Route::resource('/admin/TipeAnak/anakNonDisabilitas', AnakNonDisabilitasController::class);
    ...
    */
    ...
    // Lanjutkan pola yang sama untuk route yang lain
